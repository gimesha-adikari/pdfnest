...
import {ArrowUpRight, CheckCircle2, Search, Shield, Sparkles, Zap} from "lucide-react";
...
export default function Home() {
    ...
    return (
        <div className="flex h-full min-h-0 w-full flex-col overflow-hidden">
            ...
            <main
                className="relative min-h-screen overflow-hidden bg-[var(--background)] text-[var(--foreground)] pb-24">
                <div className="absolute inset-0 overflow-hidden pointer-events-none -z-10 select-none">
                    ...
                    <div
                        className="animate-glow-medium absolute top-10 right-0 h-[700px] w-[700px] rounded-full bg-purple-500/15 dark:bg-purple-500/10 blur-[150px]"/>
                    <div
                        className="animate-glow-fast absolute bottom-10 left-1/4 h-[700px] w-[700px] rounded-full bg-pink-500/10 dark:bg-pink-500/5 blur-[150px]"/>
                </div>
                ...
                <section className="mx-auto max-w-7xl px-6 py-4">
                    <div className="mx-auto mt-16 max-w-4xl text-center flex flex-col items-center">
                        {!isLoading && (
                            <>
                                {isPro && (
                                    <span
                                        className="inline-flex items-center gap-1.5 rounded-full border border-amber-500/30 bg-amber-500/5 text-amber-500 px-4 py-1.5 text-xs font-bold uppercase tracking-widest shadow-sm backdrop-blur-md">
                                    <Zap size={12} className="animate-pulse"/> {content.heroBadgePro}
                                </span>
                                )}
                                {isFreeUser && (
                                    <span
                                        className="inline-flex items-center gap-1.5 rounded-full border border-indigo-500/20 bg-indigo-500/5 text-indigo-500 px-4 py-1.5 text-xs font-bold uppercase tracking-widest shadow-sm backdrop-blur-md">
                                    <Zap size={12}/> {content.heroBadgeFree}
                                </span>
                                )}
                                {isGuest && (
                                    <span
                                        className="inline-flex items-center gap-1.5 rounded-full border border-indigo-500/20 bg-indigo-500/5 dark:bg-indigo-500/10 px-4 py-1.5 text-xs font-bold uppercase tracking-widest text-indigo-500 shadow-sm backdrop-blur-md">
                        ...
                        <h1 className="mt-8 text-4xl sm:text-6xl lg:text-8xl font-black tracking-tight text-[color:var(--foreground)] leading-[1.05] max-w-4xl">
                            ...
                            <span
                                className="block mt-1 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 bg-clip-text text-transparent drop-shadow-[0_2px_40px_rgba(99,102,241,0.2)] select-none">
                        ...
                        {!isLoading && (
                            <div className="mt-8 max-w-2xl w-full">
                                {isPro && (
                                    <div
                                        className="bg-[var(--card)]/40 border border-[color:var(--border)] rounded-2xl p-4 shadow-sm backdrop-blur-md flex flex-col sm:flex-row items-center justify-around gap-4 w-full">
                                        <div className="flex items-center gap-2">
                                            <CheckCircle2 className="text-emerald-500" size={18}/>
                                            <span className="text-sm font-medium text-[color:var(--muted-foreground)]">
                                            Access: <span
                                                className="text-[color:var(--foreground)] font-bold uppercase">All Premium Workspaces & Advanced Tools</span>
                                        </span>
                                        </div>
                                    </div>
                                )}
                                ...
                                {isGuest && (
                                    <p className="text-md sm:text-lg leading-relaxed text-[color:var(--muted)] font-medium">
                                        ...
                                        <span
                                            className="block mt-2 text-indigo-500/90 dark:text-indigo-400/90 font-bold">{content.heroSubtitleGuestBold}</span>
                                    </p>
                                )}
                            </div>
                        )}
                    ...
                    {(isLoading || isGuest) && (
                        <div className="mt-20 grid gap-6 sm:grid-cols-2 md:grid-cols-3 max-w-5xl mx-auto">
                            <div
                                className="rounded-3xl border border-[color:var(--border)] bg-[var(--card)]/50 backdrop-blur-xl p-6 text-center transition-all group">
                                <div
                                    className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-2xl bg-indigo-500/10 text-indigo-500 group-hover:bg-indigo-500">
                            ...
                            <div
                                className="rounded-3xl border border-[color:var(--border)] bg-[var(--card)]/50 backdrop-blur-xl p-6 text-center transition-all group">
                                <div
                                    className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-2xl bg-purple-500/10 text-purple-500 group-hover:bg-purple-500">
                            ...
                            <div
                                className="rounded-3xl border border-[color:var(--border)] bg-[var(--card)]/50 backdrop-blur-xl p-6 text-center transition-all group sm:col-span-2 md:col-span-1">
                                <div
                                    className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-2xl bg-cyan-500/10 text-cyan-500 group-hover:bg-cyan-500">
                    ...
                    <div className="mx-auto mt-16 max-w-2xl">
                        <div
                            className="rounded-2xl border border-[color:var(--border)] bg-[var(--card)]/70 p-3 shadow-xl backdrop-blur-md focus-within:border-indigo-500/50 transition-all">
                            <div className="relative">
                                <Search
                                    className="absolute left-4 top-1/2 h-5 w-5 -translate-y-1/2 text-[color:var(--muted)] pointer-events-none"/>
                                <input
                                    type="text"
                                    value={search}
                            ...
                            <div
                                className="mt-3 text-center text-xs font-bold text-[color:var(--muted)] tracking-wide uppercase">
                    ...
                    {search === "" && (
                        <section className="mt-16 max-w-5xl mx-auto">
                            <div
                                className="rounded-3xl border border-indigo-500/20 bg-gradient-to-br from-[var(--card)] to-indigo-500/5 p-8 shadow-xl relative overflow-hidden flex flex-col md:flex-row md:items-center justify-between gap-6 hover:border-indigo-500/40">
                                <div className="space-y-2 max-w-xl">
                                    <span
                                        className="text-[10px] font-black tracking-widest bg-indigo-500 text-white px-2.5 py-1 rounded-md uppercase">MOST POPULAR</span>
                                ...
                                <Link href="/merge-pdf"
                                      className="inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-indigo-500 to-purple-600 px-6 py-3.5 text-sm font-bold text-white whitespace-nowrap shadow-md">
                    ...
                    {filteredTools.length === 0 && (
                        <div
                            className="mt-20 rounded-3xl border border-dashed border-[color:var(--border)] bg-[var(--card)] p-12 text-center max-w-md mx-auto">
