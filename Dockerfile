...
ARG NEXT_PUBLIC_HYBRID_ENABLE_ALL=true
ARG APP_ENV=development
ARG MANAGED_BUILD=false
...
ENV NEXT_PUBLIC_HYBRID_ENABLE_ALL=${NEXT_PUBLIC_HYBRID_ENABLE_ALL}
ENV APP_ENV=${APP_ENV}
ENV MANAGED_BUILD=${MANAGED_BUILD}
