...
export const NAV_TOOLS_FALLBACK: ToolItem[] = [
    ...
    },
    {
        ...
        capability: {
            ...
            offlineReason: "Requires server-side OCR job processing",
        },
        clientCapable: false,
        toolPolicy: "BACKEND_ONLY",
        isNew: true,
        seoTitle: "Extract Text from PDF Online - OCR Scanned PDFs",
        seoDescription: "Extract copyable text from scanned or digital PDF documents with durable processing and page progress.",
        ...
        features: [
            ...
            "Automatic detection with manual language selection",
        ],
        faq: [
            {
                question: "Can this tool process scanned PDFs?",
                answer: "Yes. The service can detect the document language automatically or use a language you choose, then process scanned pages into copyable plain text.",
            },
            {
    ...
    },
    {
        ...
        capability: {
            ...
            workspaceOffline: false,
            requiresBackend: true,
        offlineReason: "Requires server-side OCR and PDF rendering",
        },
        clientCapable: false,
        toolPolicy: "BACKEND_ONLY",
        isNew: true,
        seoTitle: "Build a Searchable PDF Online - Create Searchable PDFs from Images",
    ...
    },
    {
        ...
        category: "convert",
        capability: { clientExecutable: false, workspaceOffline: false, requiresBackend: true, offlineReason: "Requires server-side structured document processing" },
        clientCapable: false,
        toolPolicy: "BACKEND_ONLY",
        isNew: true,
        seoTitle: "Extract Data from PDF Online - Structured PDF Extraction",
        seoDescription: "Extract structured text, sections, lists, tables, and document content from native and scanned PDFs with durable processing.",
    ...
    },
    {
        ...
        toolPolicy: "BACKEND_ONLY",
        isNew: true,
        seoTitle: "Convert PDF to Markdown - Structured Markdown Extraction",
        seoDescription: "Convert PDFs to Markdown with clean structured extraction for native and scanned pages.",
