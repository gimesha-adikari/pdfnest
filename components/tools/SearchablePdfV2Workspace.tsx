...
export default function SearchablePdfV2Workspace() {
    ...
    const selectedLanguageName = useMemo(() => capabilities?.languages.find((item) => item.code === language)?.name || language, [capabilities, language]);
