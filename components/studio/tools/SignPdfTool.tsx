        ...
        <div className="grid h-full min-h-0 grid-cols-1 gap-6 overflow-hidden p-4 lg:grid-cols-12">
            <div className="flex min-h-0 flex-col lg:col-span-5">
                <div className="flex-1 space-y-4 overflow-y-auto pr-2">
                    <div className="rounded-2xl border border-border bg-card p-6 space-y-5">
                        ...
                        <div className="space-y-3">
                            ...
                            <div
                                ...
                                <div className="flex items-center justify-between">
                                    <span
                                        className="text-sm font-semibold text-foreground">Current page</span>
                                    <span
                                        className="text-sm font-bold text-indigo-500">{currentPage} / {totalPages === 999 ? "?" : totalPages}</span>
                                </div>
                                <div className="mt-2 flex items-center justify-between">
                                    <span className="text-sm text-muted">Placed stamps</span>
                                    <span
                                        className="text-sm font-semibold text-foreground">{stamps.length}</span>
                                </div>
                            </div>
                        </div>

                        <div className="space-y-3">
                            <h2 className="text-xs font-bold uppercase tracking-wider text-muted">1.
                                Create Signature</h2>
                            <div
                        ...
                        {error && (
                            <div
                                className="rounded-2xl border border-red-500/20 bg-red-50/50 p-4 text-xs
                                text-red-600 dark:bg-red-500/10 dark:text-red-400">
                                {error}
                            </div>
                        )}
            ...
            <div className="flex min-h-0 flex-col lg:col-span-7">
                <div
                    ...
                    <div
                        className="mb-4 flex items-center justify-between border-b border-border pb-3 text-sm font-bold
                         text-foreground">
                        ...
                        <div
                            className="flex items-center gap-2 rounded-lg border border-border bg-card px-2 py-0.5 font-mono text-xs text-muted select-none">
                            <button
                                type="button"
                    ...
                    <div
                        className="relative flex-1 overflow-auto rounded-xl border border-border bg-gray-500/5 dark:bg-black/20">
                        <div className="flex min-h-full min-w-full items-start justify-center p-6">
                            {isPreviewLoading && (
                                <div
                                    ...
                                    <p className="text-xs font-semibold text-muted">Loading
                                        Page {currentPage}...</p>
                                </div>
                            )}
                    ...
                    <div className="mt-4 flex items-center justify-between gap-3">
                        <button
                            ...
                            className="inline-flex items-center gap-2 rounded-xl border border-border bg-card px-4 py-2
                             text-sm font-semibold text-foreground transition hover:bg-background
